...
-- Inserir relacionamentos cotação-fornecedor (CORRIGINDO status_resposta)
...
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT001/2024'), (SELECT id FROM fornecedores WHERE nome = 'Tech Solutions Ltda'), 'token_cot001_tech_' || extract(epoch from now())::text, 'respondido', now() - interval '2 days'),
...
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT001/2024'), (SELECT id FROM fornecedores WHERE nome = 'Automação Industrial'), 'token_cot001_automacao_' || extract(epoch from now())::text, 'visualizado', now() - interval '1 day'),

-- COT002/2024 - Ferramentas industriais
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT002/2024'), (SELECT id FROM fornecedores WHERE nome = 'Ferramentas Plus'), 'token_cot002_ferramentas_' || extract(epoch from now())::text, 'respondido', now() - interval '3 days'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT002/2024'), (SELECT id FROM fornecedores WHERE nome = 'Materiais Industriais SA'), 'token_cot002_materiais_' || extract(epoch from now())::text, 'respondido', now() - interval '2 days'),

-- COT003/2024 - Materiais de laboratório
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT003/2024'), (SELECT id FROM fornecedores WHERE nome = 'Química & Cia'), 'token_cot003_quimica_' || extract(epoch from now())::text, 'respondido', now() - interval '1 day'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT003/2024'), (SELECT id FROM fornecedores WHERE nome = 'Lab Equipamentos'), 'token_cot003_lab_' || extract(epoch from now())::text, 'respondido', now() - interval '1 day'),
...
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT005/2024'), (SELECT id FROM fornecedores WHERE nome = 'Segurança Total'), 'token_cot005_seguranca_' || extract(epoch from now())::text, 'respondido', now() - interval '2 days'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT005/2024'), (SELECT id FROM fornecedores WHERE nome = 'Suprimentos Médicos Ltda'), 'token_cot005_medicos_' || extract(epoch from now())::text, 'visualizado', now() - interval '1 day');
