...
INSERT INTO public.fornecedores (razao_social, cnpj, email, telefone, endereco, cidade, uf, cep, grupo_mercadoria, avaliacao, status, observacoes) VALUES
('Tech Solutions Ltda', '12.345.678/0001-90', 'contato@techsolutions.com.br', '(11) 3456-7890', 'Rua da Tecnologia, 123', 'São Paulo', 'SP', '01234-567', 'Eletrônicos', 4.5, 'ativo', 'Fornecedor especializado em equipamentos de TI'),
('Materiais Industriais SA', '23.456.789/0001-01', 'vendas@materiaisindustriais.com.br', '(21) 2345-6789', 'Av. Industrial, 456', 'Rio de Janeiro', 'RJ', '20123-456', 'Mecânicos', 4.2, 'ativo', 'Ampla linha de produtos industriais'),
('Química & Cia', '34.567.890/0001-12', 'comercial@quimicacia.com.br', '(31) 3567-8901', 'Rua dos Químicos, 789', 'Belo Horizonte', 'MG', '30234-567', 'Químicos', 4.7, 'ativo', 'Produtos químicos de alta qualidade'),
('Elétrica Total', '45.678.901/0001-23', 'atendimento@eletricatotal.com.br', '(41) 4567-8901', 'Av. Elétrica, 101', 'Curitiba', 'PR', '80345-678', 'Eletrônicos', 4.0, 'ativo', 'Componentes elétricos e eletrônicos'),
('Ferramentas Plus', '56.789.012/0001-34', 'vendas@ferramentasplus.com.br', '(51) 5678-9012', 'Rua das Ferramentas, 202', 'Porto Alegre', 'RS', '90456-789', 'Mecânicos', 4.3, 'ativo', 'Ferramentas profissionais e industriais'),
('Lab Equipamentos', '67.890.123/0001-45', 'contato@labequipamentos.com.br', '(85) 6789-0123', 'Av. Científica, 303', 'Fortaleza', 'CE', '60567-890', 'Laboratório', 4.6, 'ativo', 'Equipamentos para laboratórios'),
('Suprimentos Médicos Ltda', '78.901.234/0001-56', 'comercial@suprimentosmedicos.com.br', '(62) 7890-1234', 'Rua da Saúde, 404', 'Goiânia', 'GO', '74678-901', 'Médicos', 4.4, 'ativo', 'Materiais e equipamentos médicos'),
('Construção & Obra', '89.012.345/0001-67', 'vendas@construcaoobra.com.br', '(27) 8901-2345', 'Av. da Construção, 505', 'Vitória', 'ES', '29789-012', 'Construção', 3.9, 'ativo', 'Materiais para construção civil'),
('Automação Industrial', '90.123.456/0001-78', 'atendimento@automacaoindustrial.com.br', '(47) 9012-3456', 'Rua da Automação, 606', 'Joinville', 'SC', '89890-123', 'Automação', 4.8, 'ativo', 'Soluções em automação industrial'),
('Segurança Total', '01.234.567/0001-89', 'contato@segurancatotal.com.br', '(65) 0123-4567', 'Av. da Segurança, 707', 'Cuiabá', 'MT', '78901-234', 'Segurança', 4.1, 'ativo', 'Equipamentos de segurança e proteção');
...
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT001/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Tech Solutions Ltda'), 'token_cot001_tech_' || extract(epoch from now())::text, 'respondida', now() - interval '2 days'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT001/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Elétrica Total'), 'token_cot001_eletrica_' || extract(epoch from now())::text, 'pendente', now() - interval '1 day'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT001/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Automação Industrial'), 'token_cot001_automacao_' || extract(epoch from now())::text, 'visualizada', now() - interval '1 day'),

-- COT002/2024 - Ferramentas industriais
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT002/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Ferramentas Plus'), 'token_cot002_ferramentas_' || extract(epoch from now())::text, 'respondida', now() - interval '3 days'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT002/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Materiais Industriais SA'), 'token_cot002_materiais_' || extract(epoch from now())::text, 'respondida', now() - interval '2 days'),

-- COT003/2024 - Materiais de laboratório
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT003/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Química & Cia'), 'token_cot003_quimica_' || extract(epoch from now())::text, 'respondida', now() - interval '1 day'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT003/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Lab Equipamentos'), 'token_cot003_lab_' || extract(epoch from now())::text, 'respondida', now() - interval '1 day'),

-- COT004/2024 - Componentes elétricos
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT004/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Elétrica Total'), 'token_cot004_eletrica_' || extract(epoch from now())::text, 'pendente', NULL),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT004/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Automação Industrial'), 'token_cot004_automacao_' || extract(epoch from now())::text, 'pendente', NULL),

-- COT005/2024 - Equipamentos de segurança
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT005/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Segurança Total'), 'token_cot005_seguranca_' || extract(epoch from now())::text, 'respondida', now() - interval '2 days'),
((SELECT id FROM cotacoes WHERE numero_cotacao = 'COT005/2024'), (SELECT id FROM fornecedores WHERE razao_social = 'Suprimentos Médicos Ltda'), 'token_cot005_medicos_' || extract(epoch from now())::text, 'visualizada', now() - interval '1 day');
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  ...
  WHERE c.numero_cotacao = 'COT001/2024' AND f.razao_social = 'Tech Solutions Ltda'), 
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  JOIN cotacoes c ON cf.cotacao_id = c.id 
  JOIN fornecedores f ON cf.fornecedor_id = f.id 
  WHERE c.numero_cotacao = 'COT002/2024' AND f.razao_social = 'Ferramentas Plus'), 
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  JOIN cotacoes c ON cf.cotacao_id = c.id 
  JOIN fornecedores f ON cf.fornecedor_id = f.id 
  WHERE c.numero_cotacao = 'COT002/2024' AND f.razao_social = 'Materiais Industriais SA'), 
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  JOIN cotacoes c ON cf.cotacao_id = c.id 
  JOIN fornecedores f ON cf.fornecedor_id = f.id 
  WHERE c.numero_cotacao = 'COT003/2024' AND f.razao_social = 'Química & Cia'), 
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  JOIN cotacoes c ON cf.cotacao_id = c.id 
  JOIN fornecedores f ON cf.fornecedor_id = f.id 
  WHERE c.numero_cotacao = 'COT003/2024' AND f.razao_social = 'Lab Equipamentos'), 
...
((SELECT cf.id FROM cotacao_fornecedores cf 
  JOIN cotacoes c ON cf.cotacao_id = c.id 
  JOIN fornecedores f ON cf.fornecedor_id = f.id 
  WHERE c.numero_cotacao = 'COT005/2024' AND f.razao_social = 'Segurança Total'), 
